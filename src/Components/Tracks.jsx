...
const Tracks = () => {
  ...
  const activities = [
    {
      heading: "Grand ML Quiz",
      content: `
      <p>
        There will be a quiz related to various topics in Machine Learning.
      </p>
      <p class="mt-3 font-semibold">
        Perks and benefits for the winners of this quiz:
      </p>
      <ul class="list-disc list-inside mt-2 space-y-1">
        <li>Winner: Free Canva Premium for 3 months</li>
        <li>First Runner-Up: Free Canva Premium for 2 months</li>
        <li>Second Runner-Up: Free Canva Premium for 1 month</li>
      </ul>
    `,
    },
    {
      heading:
        "Sow the Seeds for the Future: Post your picture tagging @girlsleadingtech",
      content: `
      <p>
        Our buildathon motto is 
        <b>"for the environment, to the environment and by the environment"</b>.
        We encourage everyone to sow one seed in the opening ceremony of the hackathon.
      </p>
      <p class="mt-3 font-semibold">Perks for this:</p>
      <ul class="list-disc list-inside mt-2 space-y-1">
        <li>Be a part of this revolutionary movement</li>
        <li>Feature yourself on our official website for a lifetime</li>
      </ul>
    `,
    },
  ];
      ...
      <div class="flex justify-center items-center mt-20 mb-10">
        <div class="font-extrabold text-xl sm:text-2xl md:text-3xl text-red-400 text-center bg-gray-700 p-6 rounded-4xl border-r-9 border-b-9 border-red-300 hover:text-gray-700 hover:border-gray-500 relative inline-block overflow-hidden group">
          <h2 class="relative z-10">
            Activities to be undertaken during buildathon
          </h2>

          <span class="absolute inset-0 bg-red-400 translate-y-full transition-transform duration-700 ease-in-out group-hover:translate-y-0"></span>
        </div>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 justify-items-center">
        {activities.map((card) => (
          <Card
