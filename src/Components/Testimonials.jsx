  ...
  return (
    <div className="flex justify-center align-middle">
      ...
      >
        ...
        <div
          className="text-sm sm:text-base md:text-lg flex-grow overflow-hidden"
          dangerouslySetInnerHTML={{ __html: content }}
        />
        
        {/* Profile section always at bottom */}
        <div className="flex items-center mt-auto pt-3">
          <img src={photo} className="rounded-full h-12 w-12 object-cover flex-shrink-0" alt="Profile" />
          <h2 className="font-extrabold text-sm text-red-400 px-2 flex-grow">{heading}</h2>
          <a
            href={linkedinUrl}
            target="_blank"
            ...
            aria-label={`Visit ${heading}'s LinkedIn profile`}
          >
