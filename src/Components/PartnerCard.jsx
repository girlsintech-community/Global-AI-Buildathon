    ...
    <div className="group cursor-pointer">
      <div className="relative mt-10 mb-4">
        <img
          ...
          className="w-120 h-48 sm:h-56 md:h-64 rounded-2xl group-hover:scale-[1.05]
                     transform transition-all duration-500 ease-in-out group-hover:shadow-lg shadow-gray-700 mb-3 bg-white object-contain" 
        />
